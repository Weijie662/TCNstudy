...
class AudioProcessor(object):
  ...
  def get_data(self, how_many, offset, model_settings, background_frequency,
    ...
    spectogram_length=model_settings['spectrogram_length']
    dct_coefficient_count=model_settings['dct_coefficient_count']
    
    data_reshaped= np.reshape(data,[-1,spectogram_length, dct_coefficient_count])
    data= np.reshape(data_reshaped,[-1,spectogram_length* dct_coefficient_count])
